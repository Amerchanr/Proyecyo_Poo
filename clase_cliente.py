...
class Cliente(ProductosAdquiridos):
    ...
    def leerProductoContratado1(self,con):
        cursor = con.cursor()
    ...
    def insertarCliente(self,con, cliente):
        cursor = con.cursor()
        try:
    ...
    def actualizarDireccion(self,con):
        idCliente = input("ID del cliente: ")
    ...
    def consultarInformacionCliente(self,con):
